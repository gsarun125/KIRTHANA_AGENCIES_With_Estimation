...
public class DocumentViewActivity extends AppCompatActivity {
        ...
        try {
            ...
            camera.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Cursor c1;
                    if (option.equals("1")) {
                        c1 = db.getValue("SELECT printer_img FROM Deleted WHERE Bill_No ='" + billno + "'");

                    } else {
                        c1 = db.getValue("SELECT printer_img FROM Transation WHERE Bill_No ='" + billno + "'");
                    }
                    ...
                    if (dataimg != null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(DocumentViewActivity.this);
                        LayoutInflater inflater = LayoutInflater.from(DocumentViewActivity.this);
    ...
    private void editData() {
        ...
        if (option.equals("1")) {
            c1 = db.getValue("SELECT * FROM Deleted INNER JOIN customer ON  Deleted.cus_id= customer.cus_id WHERE Bill_No ='" + billno + "'");

        } else {
            c1 = db.getValue("SELECT * FROM Transation INNER JOIN customer ON  Transation.cus_id= customer.cus_id WHERE Bill_No ='" + billno + "'");
        }
        if (c1.moveToFirst()) {
            do {
                ...
                @SuppressLint("Range") Long amount = c1.getLong(c1.getColumnIndex("amount"));
                @SuppressLint("Range") String productName = c1.getString(c1.getColumnIndex("Product_Name"));
                ...
                @SuppressLint("Range") Long time1 = c1.getLong(c1.getColumnIndex("time"));
        ...
        Intent i = new Intent(DocumentViewActivity.this, SalesActivity.class);
    ...
    public void onBackPressed() {
        ...
        try {
            if (option.equals("0")) {
                Intent intent = new Intent(this, RecentInvoiceActivity.class);
    ...
    private void classicPdf() {
        ...
        try {
            ...
            new ColourPdfGenerationTask(DocumentViewActivity.this, pdfView, count, Net_AMT, Integer.parseInt(billno), cusname, phoneno, mQty, mCost, mTotal, mProduct_name, SPIS_FIRST_TIME, SPIS_FIRST_logo, file2, IGST, CGST, SGST, time).execute();
        } catch (Exception e) {
    ...
    private void colourPDF() {
        ...
        try {
            ...
            File file2 = new File(dir, fileName);
            new ClassicPdfGenerationTask(DocumentViewActivity.this, pdfView, count, Net_AMT, Integer.parseInt(billno), cusname, phoneno, mQty, mCost, mTotal, mProduct_name, SPIS_FIRST_TIME, SPIS_FIRST_logo, file2, IGST, CGST, SGST, time).execute();
        } catch (Exception e) {
    ...
    private void share() {
        ...
        try {
            ...
            if (outputFile.exists()) {
                Uri uri = FileProvider.getUriForFile(DocumentViewActivity.this, DocumentViewActivity.this.getPackageName() + ".provider", outputFile);
                ...
                Toast.makeText(DocumentViewActivity.this, R.string.file_not_found, Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
    ...
    public void delete(String mPbillno) {
        ...
        try {
            ...
            builder.setPositiveButton(R.string.yes, (DialogInterface.OnClickListener) (dialog, which) -> {
                ...
                if (option.equals("0")) {
                    Intent i = new Intent(DocumentViewActivity.this, RecentInvoiceActivity.class);
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
                } else {
                    Intent i = new Intent(DocumentViewActivity.this, HistoryActivity.class);
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
                }
    ...
    private void permanentDeletion(String billno) {
        ...
        try {
            ...
            builder.setPositiveButton(spannableYes, (DialogInterface.OnClickListener) (dialog, which) -> {
                ...
                Intent i = new Intent(DocumentViewActivity.this, DeletedInvoice.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            });
