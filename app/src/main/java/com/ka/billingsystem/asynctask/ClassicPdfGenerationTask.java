...
public class ClassicPdfGenerationTask extends AsyncTask<Void, Void, File> {
    ...
    public ClassicPdfGenerationTask(Context context, PdfRendererView pdfView, int count, Long netAmt, int billNo, String customerName, String phoneNo,
    ...
    protected File doInBackground(Void... voids) {
        return ClassicInvoice.classicPDF(count, netAmt, billNo, customerName, phoneNo, mQty, mCost, mTotal, mProductName, spIsFirstTime, spIsFirstLogo, file,time, IGST, CGST, SGST);
    }
