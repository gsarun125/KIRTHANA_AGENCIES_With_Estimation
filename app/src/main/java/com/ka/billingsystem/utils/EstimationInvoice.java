...
public class EstimationInvoice {
    public static File estimationPDF(File file, String customerName, String estimatedAmount, String gstType, Long CGST, Long SGST, Long IGST) {
        System.out.println("cusnemae:"+customerName);
        ...
        float yPosition =490;
        String[] lines = customerName.split("\n");
        ...
        long TotalAmount;
        long Net_AMT =  Long.parseLong(estimatedAmount);
        if (IGST != 0L) {
