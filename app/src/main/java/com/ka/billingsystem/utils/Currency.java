...
public class Currency {
    ...
    public static String convertToIndianCurrency(String num) {
        Logger.log("Started","convertToIndianCurrency");
        ...
        words.put(80, "Eighty");
        words.put(90, "Ninety");
        String digits[] = {"", "Hundred", "Thousand", "Lakh", "Million", "Billion", "Trillion"};
        ...
        Logger.log("Mid","convertToIndianCurrency");
        ...
        Logger.log("Ended","convertToIndianCurrency");
