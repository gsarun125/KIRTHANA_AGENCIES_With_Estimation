...
public class ProfomaColourPdfGenerationTask extends AsyncTask<Void, Void, File> {
    ...
    public ProfomaColourPdfGenerationTask(Context context, PdfRendererView pdfView, int count, Long netAmt, int billNo, String customerName, String phoneNo,
    ...
    protected File doInBackground(Void... voids) {
      Export.ExportResult data= Export.ExportData(context.getPackageName(), "Kirthana_backup.zip", create("Kirthana_backup.zip"));
        ...
        return ProfomaColourInvoice.colourPDF(count, netAmt, billNo, customerName, phoneNo, mQty, mCost, mTotal, mProductName, spIsFirstTime, spIsFirstLogo, file, time, GST, CGST, SGST);
    }
